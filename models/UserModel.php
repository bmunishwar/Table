    ...
    public static function tableConfig(): array
    {
        return [
            ...
            'columns'      => [
                ...
                ['key' => 'status',     'label' => 'Status',     'sortable' => true,  'searchable' => false, 'type' => 'status', 'filterable' => true, 'filter_options' => ['Active', 'Inactive']],
                ['key' => 'created_at', 'label' => 'Created At', 'sortable' => true,  'searchable' => false, 'type' => 'date', 'filterable' => true],
            ],
            'default_sort'  => 'id',
            'default_order' => 'asc',
            'has_actions'   => true,
